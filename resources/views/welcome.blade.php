...
@section('content')
    <div class="content col-md-12 ">
        <div class="container-fluid">
            ...
            <div class="Mtext2 col-md-8 col-md-offset-2 col-xs-12" id="Mtext2">
             ...
             <section class="testimonials text-center col-md-12 col-xs-12">
      <div class="container-fluid ">
        <h2 class="mb-5" style="color: #007bff;">Основные лица</h2>
        <div class="col-md-12 col-xs-12" >
          
            <div class="card col-md-2 col-md-offset-1 col-xs-12">
              <img src="{{ asset('images/testimonials-1.jpg') }}" alt="asdf" style="max-width:100%;margin-bottom: 5px;">
              <h3>Имя Фамилия</h3>
